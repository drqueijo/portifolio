  ...
  return (
    <S.HomeSection id="home" ref={elementRef}>
      <S.ItemsHomeWrapper>
        ...
        <S.Name>
          <p>I am Matheus Silverio.</p>
          <p>I create things for the web.</p>
        </S.Name>
        <S.About>
          <p>Fullstack developer based in Brazil.</p>
          <p>I always try to write clean code and I value performance.</p>
        </S.About>
        <Link to="portfolio" spy smooth="easeInOutQuart" duration={1000}>
